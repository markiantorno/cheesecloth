...
data class Sender(val name: String, val address: String)
data class Message(val sender: Sender, val text: String, val sentTime: Date = Date())
...
data class Tag(val text: String, val weight: Double = 1.0)
data class Category(val name: String, val tags: Array<Tag>, val senders: Array<Tag>)
data class CategoryAssociation(val category: Category, val weight: Double = 1.0)
...
////////////////////
    ...
    val dummyPersonalMessages = arrayOf(
    ...
    val personalSenderTags = arrayOf(
            Tag(john.address, 1.0),
            Tag(laura.address, 1.0),
            Tag(mary.address, -1.0),
            Tag(liu.address, -1.0),
