 ...
 */
public class MyDataSet<T extends RealmObject> extends RealmBaseDataSet<T, PieEntry> implements IPieDataSet {
     ...
     */
    public MyDataSet(RealmResults<T> result, String yValuesField) {
    ...
    public MyDataSet(RealmResults<T> result, String yValuesField, String labelField) {
        super(result, yValuesField);
